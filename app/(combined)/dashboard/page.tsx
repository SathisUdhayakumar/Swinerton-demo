  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Field Operations Dashboard</h1>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link href="/krane-chat">
            <Button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold shadow-md">
      ...
      {/* Receipts & Deliveries Section - Tied to Projects */}
        ...
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">Real-time transactions linked to project budgets</p>
            </div>
            <div className="flex items-center gap-3">
