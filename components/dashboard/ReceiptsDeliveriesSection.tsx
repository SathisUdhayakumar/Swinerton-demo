      ...
      <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            <div>
              <h2 className="text-lg font-semibold text-slate-800">Receipts & Deliveries</h2>
              <div className="flex items-center gap-2 mt-1">
                <p className="text-sm text-slate-500">Real-time transactions from site team</p>
              ...
              <div>
                ...
                {filteredReceipts.length === 0 ? (
                  <div className="text-center py-8 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-slate-500 text-sm">No receipts found for this project</p>
                    <p className="text-slate-400 text-xs mt-1">Site team can upload receipts via the workflow</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                {filteredDeliveries.length === 0 ? (
                  <div className="text-center py-8 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-slate-500 text-sm">No deliveries found for this project</p>
                    <p className="text-slate-400 text-xs mt-1">Site team can upload BOLs via the workflow</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
