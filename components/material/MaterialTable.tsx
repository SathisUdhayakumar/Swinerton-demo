...
export function MaterialTable({ projectId }: MaterialTableProps) {
  ...
  return (
    <div>
      {/* Search, Filter, Column, Group on Left | Action Icons, New Button, and Open AI Assistant on Right - Single Row */}
      <div className="flex items-center justify-between gap-3 mb-4">
        {/* Left Side: Search, Filter, Column, Group */}
        ...
        {/* Right Side: Action Icons and New Button */}
        <div className="flex items-center gap-2">
          ...
          <Button className="bg-[#fbbf24] hover:bg-[#f59e0b] text-white border-0">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
